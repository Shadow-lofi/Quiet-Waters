        ...
        <>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm text-deep-500 hover:bg-mist-200 hover:text-deep-800"
            >
              <X size={16} /> End
            </button>
          </div>
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-10">
            <BreathCircle pace={breathPace} verse={verse} paused={paused} />
